...
function clientSafeText(value, task = {}) {
  ...
  if (/生成超过10分钟|正在切换服务重试|正在切换账号重试|任务提交状态已变化/.test(text)) return "正在重试";

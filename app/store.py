...
TRANSIENT_RESULT_FIELDS = {
    ...
    "ambiguous_submission_diagnostic",
    "conversation_id",
    "cookie_string",
    "cookies",
    "main_url",
    "decoded_main_url",
    "doubao_selected_video_key",
    "doubao_video_url_score",
    "doubao_video_candidate_count",
    "doubao_watermark_status",
    "doubao_single_chain_error",
    "doubao_rejected_fallback_source",
    "doubao_rejected_fallback_key",
    "doubao_rejected_fallback_score",
    "last_query_error",

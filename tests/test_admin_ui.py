...
class AdminUITests(unittest.TestCase):
    ...
    def test_spreadsheet_batch_submission_is_complete_and_editable(self) -> None:
        ...
        self.assertIn('function batchPlanUploadTimeout(selected)', self.javascript)
        self.assertIn('timeout: batchPlanUploadTimeout(selected)', self.javascript)
        self.assertIn('Math.max(300000, Math.min(1800000', self.javascript)

...
class VersionTests(unittest.TestCase):
    def test_release_version_is_synchronized_across_build_inputs(self) -> None:
        ...
        self.assertEqual(version, "1.10.37")
        ...
        self.assertIn("DOLA_API_PROXY_ENDPOINT_LIMIT: ${DOLA_API_PROXY_ENDPOINT_LIMIT:-45}", compose)
        self.assertIn("DOLA_API_PROXY_CONTEXTS_PER_ENDPOINT: ${DOLA_API_PROXY_CONTEXTS_PER_ENDPOINT:-2}", compose)
        ...
        self.assertIn("DOLA_API_PROXY_ENDPOINT_LIMIT=45", env_example)
        self.assertIn("DOLA_API_PROXY_CONTEXTS_PER_ENDPOINT=2", env_example)
    ...
    def test_compose_file_is_valid_yaml(self) -> None:
        ...
        self.assertEqual(compose["x-app-base"]["image"], "${DOLA_IMAGE_NAME:-dola-fetch-service}:${DOLA_IMAGE_TAG:-1.10.37}")

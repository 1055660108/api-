...
class VersionTests(unittest.TestCase):
    def test_release_version_is_synchronized_across_build_inputs(self) -> None:
        ...
        self.assertEqual(version, "1.4.97")
        ...
        self.assertIn("DOLA_IMAGE_UPLOAD_CONCURRENCY: ${DOLA_IMAGE_UPLOAD_CONCURRENCY:-12}", compose)
        self.assertIn("DOLA_IMAGE_PREPARE_CONCURRENCY: ${DOLA_IMAGE_PREPARE_CONCURRENCY:-12}", compose)
        ...
        self.assertIn("DOLA_IMAGE_UPLOAD_CONCURRENCY=12", env_example)
        self.assertIn("DOLA_IMAGE_PREPARE_CONCURRENCY=12", env_example)
    ...
    def test_compose_file_is_valid_yaml(self) -> None:
        ...
        self.assertEqual(compose["x-app-base"]["image"], "${DOLA_IMAGE_NAME:-dola-fetch-service}:${DOLA_IMAGE_TAG:-1.4.97}")

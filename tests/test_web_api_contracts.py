...
class WebAPIContractTests(unittest.TestCase):
    ...
    def test_account_user_and_configuration_responses_keep_web_contracts(self) -> None:
        ...
        self.assertEqual((workers["browser_pool_processes"], workers["browser_contexts_per_process"], workers["submission_concurrency"]), (15, 3, 45))
    ...
    def test_global_worker_configuration_keeps_remote_generation_unlimited(self) -> None:
        ...
        self.assertEqual(payload["browser_workers"], 45)
        self.assertEqual(payload["max_effective_workers"], 45)
        self.assertEqual(payload["capacity_limit"], 45)
        self.assertEqual(payload["effective_browser_workers"], 45)
        self.assertEqual(payload["remote_generation_limit"], 0)
        self.assertEqual((payload["browser_pool_processes"], payload["browser_contexts_per_process"], payload["submission_concurrency"]), (15, 3, 45))
        ...
        self.assertEqual(config.load_settings().browser_workers, 45)
        ...
        self.assertEqual(config.load_settings().max_effective_workers, 45)
